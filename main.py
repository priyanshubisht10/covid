...
while True:
    ...
    print('''Services we provide:
        ...
        8) Book your bed
        9) Covid guidelines to follow
        10) Buy covid related items
        11) Do a quick covid self check
        12) Exit''')
    ...
    if Select_choice == 1:
        ...
        tts = gTTS(text='Your E Vaccination certificate has been successfully sent to your registered email address',lang='en')
        tts.save("Your E Vaccination certificate has been successfully sent to your registered email address.mp3")
        playsound.playsound(
            "Your E Vaccination certificate has been successfully sent to your registered email address.mp3")
        os.remove("Your E Vaccination certificate has been successfully sent to your registered email address.mp3")
